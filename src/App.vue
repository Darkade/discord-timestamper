...
0deg
    ...
    -webkit-transition: box-shadow 350ms,border-color 350ms,-webkit-transform 350ms;
    transition: box-shadow 350ms,border-color 350ms,transform 350ms,-webkit-transform 350ms;
    font-size: 18px;
    line-height: 35px;
}
